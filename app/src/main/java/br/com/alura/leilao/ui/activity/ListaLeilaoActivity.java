...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Renan"), 300));
        ...
        carro.propoe(new Lance(new Usuario("Joana"), 10.000));
        carro.propoe(new Lance(new Usuario("Mario"), 15.000));
        carro.propoe(new Lance(new Usuario("Ruan"), 17.000));

        return new ArrayList<>(Arrays.asList(console, computador, carro));
    }
